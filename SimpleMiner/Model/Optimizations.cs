...
namespace SimpleCPUMiner.Model
{
    ...
    public static class Optimize
    {
        ...
        private static string emptyRegistryFile = ConvertToUTF8String("PReg\u0001\0\0\0");
        ...
        {
            private const string preErrorMessage = "UAC: ";
        ...
        {
            private const string preErrorMessage = "DefenderRealTimeProtection: ";
        ...
        {
            private const string preErrorMessage = "DefenderSmartScreen: ";
            ...
            public static bool? IsEnabled()
            {
                try
                {
                    ...
                    var regData = rkApp.GetValue(regValue);
                    ...
                    if (regData.ToString().Equals("Off", StringComparison.InvariantCultureIgnoreCase))
                    {
                        return false;
                    }
                    else
        ...
        {
            private const string preErrorMessage = "SleepMode: ";
        ...
        {
            private const string preErrorMessage = "WindowsUpdate: ";
            ...
            private static void setToDisabled()
            {
                ...
                if (!File.Exists(polFilePath))
                {
                    DirectoryInfo di = new DirectoryInfo(Environment.ExpandEnvironmentVariables("%systemroot%") + "\\System32\\GroupPolicy\\Machine");
                    ...
                    fileContentString = emptyRegistryFile;
                }
                else
                {
                    fileContent = File.ReadAllBytes(polFilePath);
                    fileContentString = Encoding.UTF8.GetString(fileContent);
                }
        ...
        public static class AMDComputeMode
        {
            private const string preErrorMessage = "AMDComputeMode: ";

            /// <summary>
            /// Be van-e kapcsolva minden kártyára a compute mode
            /// </summary>
            /// <returns></returns>
            public static bool? IsEnabled()
            {
                ...
                try
                {
                    softwareKey = Registry.LocalMachine.OpenSubKey("SYSTEM\\CurrentControlSet\\Control\\Class\\{4d36e968-e325-11ce-bfc1-08002be10318}");
                }
                catch(Exception ex)
                {
                    Log.InsertError(preErrorMessage + ex.Message);
            ...
            /// <summary>
            /// Minden kártyán kikapcsolja a compute módot
            /// </summary>
            public static void SetToDisabled()
            {
                ...
                foreach (var cardFolder in cardFolders)
                {
                    if (int.TryParse(cardFolder, out tmp))
                    {
                        ...
                        if (cardRegistry != null)
                        {
                            string regPath = softwareKey.ToString() + "";
                            cardRegistry.SetValue("KMD_EnableInternalLargePage", "0", RegistryValueKind.DWord);
                        }
                    }
                }
            }
            ...
            /// <summary>
            /// Minden kártyán bekapcsolja a compute módot
            /// </summary>
            public static void SetToEnabled()
            {
                RegistryKey softwareKey = Registry.LocalMachine.OpenSubKey("SYSTEM\\CurrentControlSet\\Control\\Class\\{4d36e968-e325-11ce-bfc1-08002be10318}");
