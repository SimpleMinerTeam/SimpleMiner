...
public:
	...
	inline const char *proxyKey() const				{ return m_proxyKey.data(); }
	inline const char *proxyUrl() const				{ return m_proxyUrl.data(); }
...
protected:
	...
	xmrig::c_str m_proxyKey;
	xmrig::c_str m_proxyUrl;
	int m_proxyPort;
	bool m_useProxy;
