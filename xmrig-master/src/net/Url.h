...
public:
    ...
    constexpr static const char *kDefaultUser     = "etnkEKwVnTfcwuBnSKuQgaQetJ7SiqnH3c6TU1HXBgFkSrtwaviEkBijMVrMhGi1aP4hPKJwaaKp5Rqhxi4pyP9i26A9dRJEhW";
	constexpr static const char *kDefaultHost	  = "etnpool.sytes.net";
    ...
    inline const char *host() const          { return m_host ? m_host : kDefaultHost; }
